if( GetLocale() == "frFR" ) then
	...
	CTA_ANNOUNCE_LFG							= "Diffuser ce message LFG sur le canal aieCTAChannel.";
	CTA_ANNOUNCE_INFO_TEXT						= "Ce message LFG sera diffus\195\169 sur le canal aieCTAChannel uniquement si vous n\'h\195\169bergez pas de groupe avec CTA.\n\nUtilisez \'/cta announce <channel>\' pour envoyer votre message LFG/M sur un canal local toutes les 100 secondes et \'/cta announce off\' pour arr\195\170ter.";
	...
	CTA_FORWARD_LFX								= "Surveiller les canaux locaux et envoyer tous les messages LFG/M vers le canal aieCTAChannel.";
	...
	-- R10
	CTA_MONITOR_CHANNEL_NAME	 	= "aieLFG";
