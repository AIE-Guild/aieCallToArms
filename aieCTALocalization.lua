...
CTA_FORWARD_LFX				= "Monitor aieLFG channel (recommended)";
...
CTA_ANNOUNCED_LFM_EXT			= "Announced LFM message to aieLFG channel"
CTA_ANNOUNCED_LFG			= "Announced LFG"
CTA_ANNOUNCED_LFG_EXT			= "Announced LFG message to aieLFG channel"
...
CTA_FILTER_LFX				= "Filter spam from the aieLFG Channel (recommended)";
...
CTA_MUTE_LFG_CHANNEL		= "Mute the aieLFG channel";
